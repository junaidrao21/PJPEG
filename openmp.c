...
int main (int argc, char **argv)
{
	...
	int chunk = (row*col)/atoi(argv[2]);
#pragma omp parallel for shared(img_y, img_cr, img_cb, img_dcr, img_dy, img_dcb, DCT, row, col, chunk, temp_dcty,temp_dctcb, temp_dctcr) \
				private(i, m, n, j,x) \
